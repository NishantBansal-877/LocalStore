...
import { checkPassword, getHashPassword } from "../services/argon-service.js";
...
import {
  ...
  fillOauthEntry,
} from "../services/oauth-services.js";
...
export const googleLogin = async (req: Request, res: Response) => {
  try {
    ...
    const {
      google_oauth_state: clientState,
...
export const githubOauthPage = (req: Request, res: Response) => {
  try {
    const state = generateState();
...
export const githubLogin = async (req: Request, res: Response) => {
  try {
    ...
    const { login: name, email, avatar_url: picture } = claims as ClaimsType;
